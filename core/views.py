...
def index(request):
    ...
    return render(request, 'index.html', {'user_profile': user_profile, 'posts': feed_list, 'suggestion_username_profile_list': suggestions_username_profile_list[:4]})
...
def like_post(request):
    ...
    like_filter = LikePost.objects.filter(
        post_id=post.id, username=username).first()
